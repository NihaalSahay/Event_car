const slides =document.querySelectorAll(".slidedr") //This statement will catch all the elements having the className slide and will put them in the variable slide , here the images are elemnts on which the slides class have been put
var counter=0;
slides.forEach(
    (slide,index)=>{
